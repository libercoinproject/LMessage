...
# Form implementation generated from reading ui file 'lmessageui.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "LMessage", None))
        ...
        hours = 48
        try:
            hours = int(BMConfigParser().getint('lmessagesettings', 'ttl')/60/60)
        except:
            pass
